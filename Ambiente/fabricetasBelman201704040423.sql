...
CREATE TABLE `TEMA` (
  ...
  PRIMARY KEY (`TEMA_ID`),
  KEY `TEMA_USER_ID_FK_IDX` (`USER_ID`),
  CONSTRAINT `TEMA_USER_ID_FK` FOREIGN KEY (`USER_ID`) REFERENCES `USER` (`USER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TEMA` VALUES (1,'Religion','Acerca de la Religion','https://jollyjoker.co/tshirtecommerce/uploaded/cliparts/520/print/dg-designer-f228bda6147892601534101283710264118.svg',NULL),(2,'Musica','Acerca de la musica','https://jollyjoker.co/tshirtecommerce/uploaded/cliparts/529/print/dg-designer-2e74c2cf147892860236578299010767565.svg ',NULL),(3,'Sentimientos','Acerca de los sentimientos','https://jollyjoker.co/tshirtecommerce/uploaded/cliparts/518/print/dg-designer-7070f908147892533786563549510343450.svg',NULL);
...
INSERT INTO `FACTURA` VALUES (3,'00001','2017-03-03','5000','14000',1,NULL,NULL),(4,'00001','2017-03-03','5000','14000',1,NULL,NULL),(5,'00001','2017-03-03','2000','14000',NULL,NULL,1),(6,'00001','2017-03-03','2000','14000',NULL,NULL,1),(7,'00002','2017-01-03','2000','14000',NULL,NULL,2),(8,'00002','2017-01-03','2000','14000',NULL,NULL,2),(9,'00003','2017-04-03','2000','14000',NULL,NULL,3),(10,'00003','2017-04-03','2000','14000',NULL,NULL,3);
